#	File:	onemax_batch_with_plot.py
...
for generation in range( num_gen):
	...
	plot_worst.append( average_generational_worst )
	#x.append( generation )
	plot_average.append( average_generational_average )
	#x.append( generation )
	plot_best.append( average_generational_best )
	
   

# plotting the lines between points  
plt.plot( x, plot_worst, label = 'worst' ) 
plt.plot( x, plot_average, label = "average" )
plt.plot( x, plot_best, label = "best" )
 
# plotting points as a scatter plot 
plt.scatter( x, plot_worst, color = "blue", marker = "*", s = 30 ) 
plt.scatter( x, plot_average, color = "orange", marker = "*", s = 30 ) 
plt.scatter( x, plot_best, color = "green", marker = "*", s = 30 ) 
...
plt.title( 'OneMax Fitness Curve' ) 
